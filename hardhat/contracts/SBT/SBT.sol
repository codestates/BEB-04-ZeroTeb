...
contract SoulBoundToken is IERC5114 {
        ...
        returns (address nftAddress, uint256 nftTokenId)
    {
        ...
        require(
            owner != address(0),
            "SoulBoundToken: owner query for nonexistent token"
        );
        return (owner, index);
    }
        ...
        returns (string memory _tokenUri)
    {
        require(
            _exists(tokenId),
            "SoulBoundTokenMetadata: URI query for nonexistent token"
        );
    ...
    function _burn(uint256 tokenId) internal virtual {
        (address owner, ) = SoulBoundToken.ownerOf(tokenId);
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        // emit Approval(SoulBoundToken.ownerOf(tokenId), to, tokenId);
    }
